...
size_threshold_near = {'car':220, 'person':80, 'motorcycle':150,'truck':250,'bicycle':150, 'parking meter':0, 'cow':0, 'dog':0}
images = []
dim = (640, 480)
database = {}
...
# alert system using 3d sound
# alert system using sound
# alert system using discord - X
# use different script for alerting